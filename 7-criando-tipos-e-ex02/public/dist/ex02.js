const planets = [];
function savePlanet(name, coordinate, situation, satellites) {
    const planet = {
        name,
        coordinate,
        situation,
...
function updatePlanetSituation(newSituation, planet) {
...
function listPlanets() {
    const planetsString = planets.reduce((accum, planet) => {
        let coordinate;
        let sattelites;
...
function verification(expression, regex) {
    if (regex) {
